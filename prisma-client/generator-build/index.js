  ...
  "../../node_modules/.pnpm/debug@4.3.4/node_modules/debug/src/node.js"(exports, module2) {
    ...
    function init(debug10) {
      ...
      for (let i = 0; i < keys.length; i++) {
        debug10.inspectOpts[keys[i]] = exports.inspectOpts[keys[i]];
      }
    }
    __name(init, "init");
    module2.exports = require_common()(exports);
...
// ../../node_modules/.pnpm/@prisma+engines-version@4.10.0-18.fb90d778e372d29967a8243be3bc4e91b81f06fd/node_modules/@prisma/engines-version/package.json
var require_package = __commonJS({
  "../../node_modules/.pnpm/@prisma+engines-version@4.10.0-18.fb90d778e372d29967a8243be3bc4e91b81f06fd/node_modules/@prisma/engines-version/package.json"(exports, module2) {
    module2.exports = {
      ...
      prisma: {
        enginesVersion: "fb90d778e372d29967a8243be3bc4e91b81f06fd"
      },
      repository: {
        type: "git",
...
// ../../node_modules/.pnpm/@prisma+engines-version@4.10.0-18.fb90d778e372d29967a8243be3bc4e91b81f06fd/node_modules/@prisma/engines-version/index.js
var require_engines_version = __commonJS({
  "../../node_modules/.pnpm/@prisma+engines-version@4.10.0-18.fb90d778e372d29967a8243be3bc4e91b81f06fd/node_modules/@prisma/engines-version/index.js"(exports) {
    "use strict";
...
var require_conversions = __commonJS({
  "../../node_modules/.pnpm/color-convert@2.0.1/node_modules/color-convert/conversions.js"(exports, module2) {
    ...
    convert.rgb.xyz = function(rgb) {
      ...
      const y2 = r3 * 0.2126 + g3 * 0.7152 + b3 * 0.0722;
    ...
    convert.cmyk.rgb = function(cmyk) {
      ...
      const b3 = 1 - Math.min(1, y2 * (1 - k) + k);
      return [r3 * 255, g3 * 255, b3 * 255];
    };
    convert.xyz.rgb = function(xyz) {
      ...
      g3 = x * -0.9689 + y2 * 1.8758 + z * 0.0415;
      b3 = x * 0.0557 + y2 * -0.204 + z * 1.057;
...
var require_mode = __commonJS({
  "../../node_modules/.pnpm/isexe@2.0.0/node_modules/isexe/mode.js"(exports, module2) {
    ...
    function checkMode(stat2, options2) {
      ...
      var ug = u2 | g3;
      var ret = mod2 & o2 || mod2 & g3 && gid === myGid || mod2 & u2 && uid === myUid || mod2 & ug && myUid === 0;
      return ret;
    }
...
var require_conversions2 = __commonJS({
  "../../node_modules/.pnpm/color-convert@1.9.3/node_modules/color-convert/conversions.js"(exports, module2) {
    ...
    convert.rgb.xyz = function(rgb) {
      ...
      var y2 = r3 * 0.2126 + g3 * 0.7152 + b3 * 0.0722;
    ...
    convert.cmyk.rgb = function(cmyk) {
      ...
      g3 = 1 - Math.min(1, m2 * (1 - k) + k);
      b3 = 1 - Math.min(1, y2 * (1 - k) + k);
      return [r3 * 255, g3 * 255, b3 * 255];
    };
    convert.xyz.rgb = function(xyz) {
      var x = xyz[0] / 100;
...
var require_semver = __commonJS({
  "../../node_modules/.pnpm/semver@5.7.1/node_modules/semver/semver.js"(exports, module2) {
    ...
    if (typeof process === "object" && process.env && process.env.NODE_DEBUG && /\bsemver\b/i.test(process.env.NODE_DEBUG)) {
      debug10 = /* @__PURE__ */ __name(function() {
    ...
    function SemVer(version2, options2) {
      ...
      debug10("SemVer", version2, options2);
    ...
    SemVer.prototype.comparePre = function(other) {
      ...
      do {
        ...
        debug10("prerelease compare", i2, a, b3);
    ...
    function Comparator(comp, options2) {
      ...
      debug10("comparator", comp, options2);
      this.options = options2;
      this.loose = !!options2.loose;
      this.parse(comp);
      if (this.semver === ANY) {
    ...
    Range.prototype.parseRange = function(range) {
      ...
      debug10("comparator trim", range, re[COMPARATORTRIM]);
    ...
    function replaceTilde(comp, options2) {
      ...
      return comp.replace(r3, function(_, M, m2, p3, pr) {
        debug10("tilde", comp, _, M, m2, p3, pr);
        var ret;
        if (isX(M)) {
          ret = "";
        } else if (isX(m2)) {
          ...
          ret = ">=" + M + "." + m2 + "." + p3 + "-" + pr + " <" + M + "." + (+m2 + 1) + ".0";
        } else {
          ret = ">=" + M + "." + m2 + "." + p3 + " <" + M + "." + (+m2 + 1) + ".0";
        }
    ...
    function replaceCaret(comp, options2) {
      debug10("caret", comp, options2);
      var r3 = options2.loose ? re[CARETLOOSE] : re[CARET];
      return comp.replace(r3, function(_, M, m2, p3, pr) {
        debug10("caret", comp, _, M, m2, p3, pr);
        var ret;
        if (isX(M)) {
          ret = "";
        } else if (isX(m2)) {
          ...
          if (M === "0") {
            if (m2 === "0") {
              ret = ">=" + M + "." + m2 + "." + p3 + "-" + pr + " <" + M + "." + m2 + "." + (+p3 + 1);
            } else {
              ret = ">=" + M + "." + m2 + "." + p3 + "-" + pr + " <" + M + "." + (+m2 + 1) + ".0";
            }
          } else {
            ret = ">=" + M + "." + m2 + "." + p3 + "-" + pr + " <" + (+M + 1) + ".0.0";
          }
        } else {
          debug10("no pr");
          if (M === "0") {
            if (m2 === "0") {
              ret = ">=" + M + "." + m2 + "." + p3 + " <" + M + "." + m2 + "." + (+p3 + 1);
            } else {
              ret = ">=" + M + "." + m2 + "." + p3 + " <" + M + "." + (+m2 + 1) + ".0";
            }
          } else {
    ...
    function replaceXRanges(comp, options2) {
      debug10("replaceXRanges", comp, options2);
    ...
    function replaceXRange(comp, options2) {
      ...
      return comp.replace(r3, function(ret, gtlt, M, m2, p3, pr) {
        debug10("xRange", comp, ret, gtlt, M, m2, p3, pr);
        var xM = isX(M);
        var xm = xM || isX(m2);
        var xp = xm || isX(p3);
        var anyX = xp;
    ...
    function replaceStars(comp, options2) {
      debug10("replaceStars", comp, options2);
...
var require_graceful_fs = __commonJS({
  "../../node_modules/.pnpm/graceful-fs@4.2.10/node_modules/graceful-fs/graceful-fs.js"(exports, module2) {
    ...
    function enqueue(elem) {
      debug10("ENQUEUE", elem[0].name, elem[1]);
    ...
    function retry() {
      ...
      var lastTime = elem[4];
      if (startTime === void 0) {
        debug10("RETRY", fn.name, args);
        fn.apply(null, args);
      } else if (Date.now() - startTime >= 6e4) {
        debug10("TIMEOUT", fn.name, args);
        var cb = args.pop();
        if (typeof cb === "function")
          cb.call(null, err);
      } else {
...
var require_fs = __commonJS({
  "../../node_modules/.pnpm/fs-extra@11.1.0/node_modules/fs-extra/lib/fs/index.js"(exports) {
    ...
    api.forEach((method2) => {
      exports[method2] = u2(fs13[method2]);
    });
    ...
    if (typeof fs13.realpath.native === "function") {
      exports.realpath.native = u2(fs13.realpath.native);
    } else {
      process.emitWarning(
...
var require_path_exists2 = __commonJS({
  "../../node_modules/.pnpm/fs-extra@11.1.0/node_modules/fs-extra/lib/path-exists/index.js"(exports, module2) {
    ...
    function pathExists(path9) {
      return fs13.access(path9).then(() => true).catch(() => false);
    }
...
var require_utimes = __commonJS({
  "../../node_modules/.pnpm/fs-extra@11.1.0/node_modules/fs-extra/lib/util/utimes.js"(exports, module2) {
    ...
    function utimesMillisSync(path9, atime, mtime) {
      const fd = fs13.openSync(path9, "r+");
...
var require_stat = __commonJS({
  "../../node_modules/.pnpm/fs-extra@11.1.0/node_modules/fs-extra/lib/util/stat.js"(exports, module2) {
    ...
    function getStats(src, dest, opts) {
      const statFunc = opts.dereference ? (file2) => fs13.stat(file2, { bigint: true }) : (file2) => fs13.lstat(file2, { bigint: true });
      return Promise.all([
        statFunc(src),
    ...
    function getStatsSync(src, dest, opts) {
      let destStat;
      const statFunc = opts.dereference ? (file2) => fs13.statSync(file2, { bigint: true }) : (file2) => fs13.lstatSync(file2, { bigint: true });
...
var require_copy = __commonJS({
  "../../node_modules/.pnpm/fs-extra@11.1.0/node_modules/fs-extra/lib/copy/copy.js"(exports, module2) {
    ...
    function getStats(destStat, src, dest, opts, cb) {
      const stat3 = opts.dereference ? fs13.stat : fs13.lstat;
...
var require_remove = __commonJS({
  "../../node_modules/.pnpm/fs-extra@11.1.0/node_modules/fs-extra/lib/remove/index.js"(exports, module2) {
    ...
    function remove2(path9, callback) {
      fs13.rm(path9, { recursive: true, force: true }, callback);
    }
    __name(remove2, "remove");
    function removeSync(path9) {
      fs13.rmSync(path9, { recursive: true, force: true });
    }
...
var require_file = __commonJS({
  "../../node_modules/.pnpm/fs-extra@11.1.0/node_modules/fs-extra/lib/ensure/file.js"(exports, module2) {
    ...
    function createFile(file2, callback) {
      ...
      fs13.stat(file2, (err, stats) => {
        if (!err && stats.isFile())
          return callback();
        const dir2 = path9.dirname(file2);
        fs13.stat(dir2, (err2, stats2) => {
          if (err2) {
            if (err2.code === "ENOENT") {
    ...
    function createFileSync(file2) {
      ...
      const dir2 = path9.dirname(file2);
      try {
        if (!fs13.statSync(dir2).isDirectory()) {
          fs13.readdirSync(dir2);
        }
      } catch (err) {
...
var require_link = __commonJS({
  "../../node_modules/.pnpm/fs-extra@11.1.0/node_modules/fs-extra/lib/ensure/link.js"(exports, module2) {
    ...
    function createLinkSync(srcpath, dstpath) {
      ...
      const dir2 = path9.dirname(dstpath);
      const dirExists = fs13.existsSync(dir2);
      if (dirExists)
  ...
  "../../node_modules/.pnpm/fs-extra@11.1.0/node_modules/fs-extra/lib/ensure/symlink-paths.js"(exports, module2) {
    ...
    function symlinkPaths(srcpath, dstpath, callback) {
      if (path9.isAbsolute(srcpath)) {
        ...
        return pathExists(relativeToDst, (err, exists5) => {
          if (err)
            return callback(err);
          if (exists5) {
            return callback(null, {
    ...
    function symlinkPathsSync(srcpath, dstpath) {
      let exists5;
      if (path9.isAbsolute(srcpath)) {
        exists5 = fs13.existsSync(srcpath);
        if (!exists5)
        ...
        const dstdir = path9.dirname(dstpath);
        const relativeToDst = path9.join(dstdir, srcpath);
        exists5 = fs13.existsSync(relativeToDst);
        if (exists5) {
          return {
            toCwd: relativeToDst,
            toDst: srcpath
...
var require_symlink = __commonJS({
  "../../node_modules/.pnpm/fs-extra@11.1.0/node_modules/fs-extra/lib/ensure/symlink.js"(exports, module2) {
        ...
        symlinkType(relative.toCwd, type, (err2, type2) => {
          ...
          pathExists(dir2, (err3, dirExists) => {
            if (err3)
              return callback(err3);
            if (dirExists)
              return fs13.symlink(srcpath, dstpath, type2, callback);
            mkdirs(dir2, (err4) => {
              if (err4)
    ...
    function createSymlinkSync(srcpath, dstpath, type) {
      ...
      const dir2 = path9.dirname(dstpath);
      const exists5 = fs13.existsSync(dir2);
      if (exists5)
...
var require_jsonfile = __commonJS({
  "../../node_modules/.pnpm/jsonfile@6.1.0/node_modules/jsonfile/index.js"(exports, module2) {
    ...
    async function _readFile(file2, options2 = {}) {
      ...
      let data = await universalify.fromCallback(fs13.readFile)(file2, options2);
      data = stripBom(data);
      let obj;
      try {
    ...
    function readFileSync(file2, options2 = {}) {
      ...
      const shouldThrow = "throws" in options2 ? options2.throws : true;
      try {
        let content = fs13.readFileSync(file2, options2);
    ...
    async function _writeFile(file2, obj, options2 = {}) {
      ...
      await universalify.fromCallback(fs13.writeFile)(file2, str, options2);
    }
    ...
    function writeFileSync(file2, obj, options2 = {}) {
      const fs13 = options2.fs || _fs;
      const str = stringify2(obj, options2);
      return fs13.writeFileSync(file2, str, options2);
    }
  ...
  "../../node_modules/.pnpm/fs-extra@11.1.0/node_modules/fs-extra/lib/output-file/index.js"(exports, module2) {
    ...
    function outputFile(file2, data, encoding, callback) {
      ...
      pathExists(dir2, (err, itDoes) => {
        if (err)
          return callback(err);
        if (itDoes)
          return fs13.writeFile(file2, data, encoding, callback);
        mkdir.mkdirs(dir2, (err2) => {
          if (err2)
            return callback(err2);
          fs13.writeFile(file2, data, encoding, callback);
        });
      });
    }
    ...
    function outputFileSync(file2, ...args) {
      ...
      if (fs13.existsSync(dir2)) {
        return fs13.writeFileSync(file2, ...args);
      }
      mkdir.mkdirsSync(dir2);
      fs13.writeFileSync(file2, ...args);
    }
...
var require_semver2 = __commonJS({
  "../../node_modules/.pnpm/semver@6.3.0/node_modules/semver/semver.js"(exports, module2) {
    ...
    src[t4.NUMERICIDENTIFIER] = "0|[1-9]\\d*";
    tok("NUMERICIDENTIFIERLOOSE");
    src[t4.NUMERICIDENTIFIERLOOSE] = "[0-9]+";
    tok("NONNUMERICIDENTIFIER");
    src[t4.NONNUMERICIDENTIFIER] = "\\d*[a-zA-Z-][a-zA-Z0-9-]*";
    tok("MAINVERSION");
    src[t4.MAINVERSION] = "(" + src[t4.NUMERICIDENTIFIER] + ")\\.(" + src[t4.NUMERICIDENTIFIER] + ")\\.(" + src[t4.NUMERICIDENTIFIER] + ")";
    tok("MAINVERSIONLOOSE");
    src[t4.MAINVERSIONLOOSE] = "(" + src[t4.NUMERICIDENTIFIERLOOSE] + ")\\.(" + src[t4.NUMERICIDENTIFIERLOOSE] + ")\\.(" + src[t4.NUMERICIDENTIFIERLOOSE] + ")";
    tok("PRERELEASEIDENTIFIER");
    src[t4.PRERELEASEIDENTIFIER] = "(?:" + src[t4.NUMERICIDENTIFIER] + "|" + src[t4.NONNUMERICIDENTIFIER] + ")";
    tok("PRERELEASEIDENTIFIERLOOSE");
    src[t4.PRERELEASEIDENTIFIERLOOSE] = "(?:" + src[t4.NUMERICIDENTIFIERLOOSE] + "|" + src[t4.NONNUMERICIDENTIFIER] + ")";
    tok("PRERELEASE");
    src[t4.PRERELEASE] = "(?:-(" + src[t4.PRERELEASEIDENTIFIER] + "(?:\\." + src[t4.PRERELEASEIDENTIFIER] + ")*))";
    tok("PRERELEASELOOSE");
    src[t4.PRERELEASELOOSE] = "(?:-?(" + src[t4.PRERELEASEIDENTIFIERLOOSE] + "(?:\\." + src[t4.PRERELEASEIDENTIFIERLOOSE] + ")*))";
    tok("BUILDIDENTIFIER");
    src[t4.BUILDIDENTIFIER] = "[0-9A-Za-z-]+";
    tok("BUILD");
    src[t4.BUILD] = "(?:\\+(" + src[t4.BUILDIDENTIFIER] + "(?:\\." + src[t4.BUILDIDENTIFIER] + ")*))";
    tok("FULL");
    tok("FULLPLAIN");
    src[t4.FULLPLAIN] = "v?" + src[t4.MAINVERSION] + src[t4.PRERELEASE] + "?" + src[t4.BUILD] + "?";
    src[t4.FULL] = "^" + src[t4.FULLPLAIN] + "$";
    tok("LOOSEPLAIN");
    src[t4.LOOSEPLAIN] = "[v=\\s]*" + src[t4.MAINVERSIONLOOSE] + src[t4.PRERELEASELOOSE] + "?" + src[t4.BUILD] + "?";
    tok("LOOSE");
    src[t4.LOOSE] = "^" + src[t4.LOOSEPLAIN] + "$";
    tok("GTLT");
    src[t4.GTLT] = "((?:<|>)?=?)";
    tok("XRANGEIDENTIFIERLOOSE");
    src[t4.XRANGEIDENTIFIERLOOSE] = src[t4.NUMERICIDENTIFIERLOOSE] + "|x|X|\\*";
    tok("XRANGEIDENTIFIER");
    src[t4.XRANGEIDENTIFIER] = src[t4.NUMERICIDENTIFIER] + "|x|X|\\*";
    tok("XRANGEPLAIN");
    src[t4.XRANGEPLAIN] = "[v=\\s]*(" + src[t4.XRANGEIDENTIFIER] + ")(?:\\.(" + src[t4.XRANGEIDENTIFIER] + ")(?:\\.(" + src[t4.XRANGEIDENTIFIER] + ")(?:" + src[t4.PRERELEASE] + ")?" + src[t4.BUILD] + "?)?)?";
    tok("XRANGEPLAINLOOSE");
    src[t4.XRANGEPLAINLOOSE] = "[v=\\s]*(" + src[t4.XRANGEIDENTIFIERLOOSE] + ")(?:\\.(" + src[t4.XRANGEIDENTIFIERLOOSE] + ")(?:\\.(" + src[t4.XRANGEIDENTIFIERLOOSE] + ")(?:" + src[t4.PRERELEASELOOSE] + ")?" + src[t4.BUILD] + "?)?)?";
    tok("XRANGE");
    src[t4.XRANGE] = "^" + src[t4.GTLT] + "\\s*" + src[t4.XRANGEPLAIN] + "$";
    tok("XRANGELOOSE");
    src[t4.XRANGELOOSE] = "^" + src[t4.GTLT] + "\\s*" + src[t4.XRANGEPLAINLOOSE] + "$";
    tok("COERCE");
    src[t4.COERCE] = "(^|[^\\d])(\\d{1," + MAX_SAFE_COMPONENT_LENGTH + "})(?:\\.(\\d{1," + MAX_SAFE_COMPONENT_LENGTH + "}))?(?:\\.(\\d{1," + MAX_SAFE_COMPONENT_LENGTH + "}))?(?:$|[^\\d])";
    tok("COERCERTL");
    re[t4.COERCERTL] = new RegExp(src[t4.COERCE], "g");
    tok("LONETILDE");
    src[t4.LONETILDE] = "(?:~>?)";
    tok("TILDETRIM");
    src[t4.TILDETRIM] = "(\\s*)" + src[t4.LONETILDE] + "\\s+";
    re[t4.TILDETRIM] = new RegExp(src[t4.TILDETRIM], "g");
    var tildeTrimReplace = "$1~";
    tok("TILDE");
    src[t4.TILDE] = "^" + src[t4.LONETILDE] + src[t4.XRANGEPLAIN] + "$";
    tok("TILDELOOSE");
    src[t4.TILDELOOSE] = "^" + src[t4.LONETILDE] + src[t4.XRANGEPLAINLOOSE] + "$";
    tok("LONECARET");
    src[t4.LONECARET] = "(?:\\^)";
    tok("CARETTRIM");
    src[t4.CARETTRIM] = "(\\s*)" + src[t4.LONECARET] + "\\s+";
    re[t4.CARETTRIM] = new RegExp(src[t4.CARETTRIM], "g");
    var caretTrimReplace = "$1^";
    tok("CARET");
    src[t4.CARET] = "^" + src[t4.LONECARET] + src[t4.XRANGEPLAIN] + "$";
    tok("CARETLOOSE");
    src[t4.CARETLOOSE] = "^" + src[t4.LONECARET] + src[t4.XRANGEPLAINLOOSE] + "$";
    tok("COMPARATORLOOSE");
    src[t4.COMPARATORLOOSE] = "^" + src[t4.GTLT] + "\\s*(" + src[t4.LOOSEPLAIN] + ")$|^$";
    tok("COMPARATOR");
    src[t4.COMPARATOR] = "^" + src[t4.GTLT] + "\\s*(" + src[t4.FULLPLAIN] + ")$|^$";
    tok("COMPARATORTRIM");
    src[t4.COMPARATORTRIM] = "(\\s*)" + src[t4.GTLT] + "\\s*(" + src[t4.LOOSEPLAIN] + "|" + src[t4.XRANGEPLAIN] + ")";
    re[t4.COMPARATORTRIM] = new RegExp(src[t4.COMPARATORTRIM], "g");
    var comparatorTrimReplace = "$1$2$3";
    tok("HYPHENRANGE");
    src[t4.HYPHENRANGE] = "^\\s*(" + src[t4.XRANGEPLAIN] + ")\\s+-\\s+(" + src[t4.XRANGEPLAIN] + ")\\s*$";
    tok("HYPHENRANGELOOSE");
    src[t4.HYPHENRANGELOOSE] = "^\\s*(" + src[t4.XRANGEPLAINLOOSE] + ")\\s+-\\s+(" + src[t4.XRANGEPLAINLOOSE] + ")\\s*$";
    tok("STAR");
    src[t4.STAR] = "(<|>)?=?\\s*\\*";
    for (i = 0; i < R; i++) {
      debug10(i, src[i]);
    ...
    function parse(version2, options2) {
      ...
      var r3 = options2.loose ? re[t4.LOOSE] : re[t4.FULL];
      if (!r3.test(version2)) {
        return null;
      }
      try {
    ...
    function SemVer(version2, options2) {
      ...
      this.options = options2;
      this.loose = !!options2.loose;
      var m2 = version2.trim().match(options2.loose ? re[t4.LOOSE] : re[t4.FULL]);
      if (!m2) {
        throw new TypeError("Invalid Version: " + version2);
      }
      this.raw = version2;
    ...
    var ANY = {};
    Comparator.prototype.parse = function(comp) {
      var r3 = this.options.loose ? re[t4.COMPARATORLOOSE] : re[t4.COMPARATOR];
      var m2 = comp.match(r3);
      if (!m2) {
        throw new TypeError("Invalid comparator: " + comp);
      }
    ...
    __name(replaceTildes, "replaceTildes");
    function replaceTilde(comp, options2) {
      var r3 = options2.loose ? re[t4.TILDELOOSE] : re[t4.TILDE];
      return comp.replace(r3, function(_, M, m2, p3, pr) {
        debug10("tilde", comp, _, M, m2, p3, pr);
        var ret;
        if (isX(M)) {
    ...
    function replaceCaret(comp, options2) {
      debug10("caret", comp, options2);
      var r3 = options2.loose ? re[t4.CARETLOOSE] : re[t4.CARET];
      return comp.replace(r3, function(_, M, m2, p3, pr) {
        debug10("caret", comp, _, M, m2, p3, pr);
        var ret;
        if (isX(M)) {
    ...
    function replaceXRange(comp, options2) {
      comp = comp.trim();
      var r3 = options2.loose ? re[t4.XRANGELOOSE] : re[t4.XRANGE];
      return comp.replace(r3, function(ret, gtlt, M, m2, p3, pr) {
        debug10("xRange", comp, ret, gtlt, M, m2, p3, pr);
        var xM = isX(M);
        var xm = xM || isX(m2);
    ...
    function coerce(version2, options2) {
      ...
      var match3 = null;
      if (!options2.rtl) {
        match3 = version2.match(re[t4.COERCE]);
      } else {
        var next;
        while ((next = re[t4.COERCERTL].exec(version2)) && (!match3 || match3.index + match3[0].length !== version2.length)) {
          if (!match3 || next.index + next[0].length !== match3.index + match3[0].length) {
            match3 = next;
          }
          re[t4.COERCERTL].lastIndex = next.index + next[1].length + next[2].length;
        }
        re[t4.COERCERTL].lastIndex = -1;
      }
      if (match3 === null) {
        return null;
      }
...
var require_package4 = __commonJS({
  "package.json"(exports, module2) {
    module2.exports = {
      ...
      dependencies: {
        "@prisma/engines-version": "4.10.0-18.fb90d778e372d29967a8243be3bc4e91b81f06fd"
      },
      sideEffects: false
    };
  }
  ...
  "../../node_modules/.pnpm/flat-map-polyfill@0.3.8/node_modules/flat-map-polyfill/dist/cjs/flat-map.js"() {
    ...
    if (!Object.prototype.hasOwnProperty.call(Array.prototype, "flatMap")) {
      Array.prototype.flatMap = /* @__PURE__ */ __name(function flatMap(callbackFn, thisArg) {
        ...
        var t4 = thisArg !== void 0 ? thisArg : void 0;
...
var r = /* @__PURE__ */ __name((t4) => t4 && !!t4[e], "r");
var o = /* @__PURE__ */ __name((t4, c, a) => {
  if (n(t4)) {
    if (r(t4)) {
      const n3 = t4[e](), { matched: r3, selections: o2 } = n3.match(c);
      return r3 && o2 && Object.keys(o2).forEach((e3) => a(e3, o2[e3])), r3;
    }
    if (!n(c))
      return false;
    if (Array.isArray(t4))
      return !!Array.isArray(c) && t4.length === c.length && t4.every((e3, t5) => o(e3, c[t5], a));
    if (t4 instanceof Map)
      return c instanceof Map && Array.from(t4.keys()).every((e3) => o(t4.get(e3), c.get(e3), a));
    if (t4 instanceof Set) {
      ...
      if (0 === t4.size)
        return 0 === c.size;
      if (1 === t4.size) {
        const [e3] = Array.from(t4.values());
        return r(e3) ? Array.from(c.values()).every((t5) => o(e3, t5, a)) : c.has(e3);
      }
      return Array.from(t4.values()).every((e3) => c.has(e3));
    }
    return Object.keys(t4).every((n3) => {
      const s = t4[n3];
      return (n3 in c || r(i = s) && "optional" === i[e]().matcherType) && o(s, c[n3], a);
      var i;
    });
  }
  return Object.is(c, t4);
}, "o");
function f(t4) {
  return { [e]: () => ({ match: (e3) => ({ matched: Boolean(t4(e3)) }) }) };
}
__name(f, "f");
var m = f(function(e3) {
  return true;
...
var O = class {
  constructor(e3, t4) {
    this.value = void 0, this.cases = void 0, this.value = e3, this.cases = t4;
  }
  with(...e3) {
    ...
    return 3 === e3.length && "function" == typeof e3[1] ? (r3.push(e3[0]), c.push(e3[1])) : e3.length > 2 && r3.push(...e3.slice(1, e3.length - 1)), new O(this.value, this.cases.concat([{ match: (e4) => {
      let n4 = {};
      const a = Boolean(r3.some((t4) => o(t4, e4, (e5, t5) => {
        n4[e5] = t5;
      })) && c.every((t4) => t4(e4)));
  ...
  when(e3, t4) {
    return new O(this.value, this.cases.concat([{ match: (t5) => ({ matched: Boolean(e3(t5)), value: t5 }), handler: t4 }]));
  }
  otherwise(e3) {
  ...
  run() {
    let e3, t4 = this.value;
    for (let n3 = 0; n3 < this.cases.length; n3++) {
      const r3 = this.cases[n3], o2 = r3.match(this.value);
      if (o2.matched) {
        t4 = o2.value, e3 = r3.handler;
        break;
      }
    }
    if (!e3) {
...
var u = /* @__PURE__ */ __name(function t3(u2, i, c) {
  if (e2(u2)) {
    if (r2(u2)) {
      var o2 = u2[n2]().match(i), a = o2.matched, f2 = o2.selections;
      return a && f2 && Object.keys(f2).forEach(function(n3) {
        return c(n3, f2[n3]);
      }), a;
    }
    if (!e2(i))
      return false;
    if (Array.isArray(u2))
      return !!Array.isArray(i) && u2.length === i.length && u2.every(function(n3, e3) {
        return t3(n3, i[e3], c);
      });
    if (u2 instanceof Map)
      return i instanceof Map && Array.from(u2.keys()).every(function(n3) {
        return t3(u2.get(n3), i.get(n3), c);
      });
    if (u2 instanceof Set) {
      ...
      if (1 === u2.size) {
        ...
        return r2(s) ? Array.from(i.values()).every(function(n3) {
          return t3(s, n3, c);
        }) : i.has(s);
      }
      return Array.from(u2.values()).every(function(n3) {
        return i.has(n3);
      });
    }
    return Object.keys(u2).every(function(e3) {
      var o3, a2 = u2[e3];
      return (e3 in i || r2(o3 = a2) && "optional" === o3[n2]().matcherType) && t3(a2, i[e3], c);
    });
  }
...
var g2 = h(function(n3) {
  return "number" == typeof n3;
});
var p2 = h(function(n3) {
  return "boolean" == typeof n3;
});
var b2 = h(function(n3) {
...
var O2 = /* @__PURE__ */ function() {
  function n3(n4, t4) {
    this.value = void 0, this.cases = void 0, this.value = n4, this.cases = t4;
  }
  __name(n3, "n");
  var e3 = n3.prototype;
  return e3.with = function() {
    var e4 = [].slice.call(arguments), r3 = e4[e4.length - 1], i = [e4[0]], c = [];
    return 3 === e4.length && "function" == typeof e4[1] ? (i.push(e4[0]), c.push(e4[1])) : e4.length > 2 && i.push.apply(i, e4.slice(1, e4.length - 1)), new n3(this.value, this.cases.concat([{ match: function(n4) {
      var e5 = {}, r4 = Boolean(i.some(function(t4) {
        return u(t4, n4, function(n5, t5) {
          e5[n5] = t5;
        });
      }) && c.every(function(t4) {
        return t4(n4);
    ...
    return new n3(this.value, this.cases.concat([{ match: function(n4) {
      return { matched: Boolean(t4(n4)), value: n4 };
    }, handler: e4 }]));
    ...
    for (var n4 = this.value, t4 = void 0, e4 = 0; e4 < this.cases.length; e4++) {
      var r3 = this.cases[e4], u2 = r3.match(this.value);
      if (u2.matched) {
        n4 = u2.value, t4 = r3.handler;
        break;
      }
    }
    if (!t4) {
...
var tags = {
  warn: import_chalk4.default.yellow("prisma:warn")
};
var should = {
...
async function getSSLVersion(args) {
  ...
  const libsslSpecificPaths = K2(args).with({ distro: "musl" }, () => {
    ...
    debug4(`Don't know any platform-specific paths for "${distro}" on ${arch}`);
    return [];
  });
  const libsslSpecificCommands = libsslSpecificPaths.map((path9) => `ls ${path9} | grep libssl.so`);
...
async function getPlatform() {
  ...
  if (platform === "linux" && libssl === void 0) {
    const additionalMessage = K2({ distro }).with({ distro: "debian" }, () => {
...
${additionalMessage}`
  ...
  if (platform === "linux" && distro === void 0) {
    warnOnce(
      "distro:undefined",
  ...
  return function(f2) {
    return function(ma) {
      return M.chain(ma, function(e3) {
        return isLeft2(e3) ? M.of(e3) : f2(e3.right);
      });
    };
  };
}
      ...
      (e3) => {
        ...
        const proposedErrorFixMessage = K(error.message).when(
          ...
          () => {
            ...
            return ` It seems that the current architecture ${import_chalk5.default.redBright(
              architecture
            )} is not supported, or that ${import_chalk5.default.redBright("libc")} is missing from the system.`;
          }
        ).otherwise(() => "");
...
var createDebugErrorType = /* @__PURE__ */ __name((debug10, fnName) => ({ type, reason, error }) => {
  debug10(`error of type "${type}" in ${fnName}:
`, { reason, error });
}, "createDebugErrorType");
function createSchemaValidationError(reason) {
  return `${import_chalk5.default.redBright.bold("Prisma schema validation")} - ${reason}`;
}
...
${message}`;
      ...
      const detailsHeader = import_chalk6.default.red.bold("Details:");
      return `${reason}
...
async function getDmmfNodeAPI(options2) {
  const debugErrorType = createDebugErrorType(debug8, "getDmmfNodeAPI");
  ...
  const pipeline = (0, import_function5.pipe)(
        ...
        tryCatch2(
          () => {
            if (process.env.FORCE_PANIC_QUERY_ENGINE_GET_DMMF) {
              debug8("Triggering a Rust panic...");
    ...
    chainW(({ result }) => {
      debug8("unserialized dmmf result ready");
      return (0, import_function5.pipe)(
        tryCatch(
          () => JSON.parse(result),
          (e3) => ({
  ...
  if (isRight2(dmmfEither)) {
    debug8("dmmf retrieved without errors in getDmmfNodeAPI");
  ...
  const error = K(dmmfEither.left).with({ type: "node-api" }, (e3) => {
    ...
    const actualError = (0, import_function5.pipe)(
      tryCatch(
        ...
        () => {
          debug8(`Couldn't apply JSON.parse to "${errorOutput}"`);
      ...
      map2((errorOutputAsJSON) => {
        if (errorOutputAsJSON.is_panic) {
          ...
          debug8(`panic in getDmmfNodeAPI "${e3.type}"`, panic);
          return panic;
        }
...
async function getDmmfBinary(options2) {
  const debugErrorType = createDebugErrorType(debug8, "getDmmfBinary");
  ...
  debug8(`Using CLI Query Engine (Binary) at: ${queryEnginePath}`);
  debug8(`PRISMA_DML_PATH: ${tempDatamodelPath}`);
  const pipeline = (0, import_function5.pipe)(
    (() => {
      const execaOptions = {
        cwd: options2.cwd,
  ...
  const dmmfEither = await pipeline();
  if (isRight2(dmmfEither)) {
    debug8("dmmf retrieved without errors in getDmmfBinary");
  ...
  const errorEither = K(dmmfEither.left).with({ type: "execa" }, (e3) => {
    ...
    if (isExecaErrorCausedByRustPanic(e3.error)) {
      const panic = new RustPanic(
        ...
        options2.datamodelPath ?? tempDatamodelPath,
        void 0
      );
      debug8(`panic in getDmmfBinary "${e3.type}"`, panic);
      return right2(panic);
    }
    const errorOutput = e3.error.stderr ?? e3.error.stdout;
    const actualError = (0, import_function5.pipe)(
      tryCatch(
        () => JSON.parse(errorOutput),
        () => {
      ...
      map2((errorOutputAsJSON) => {
        const defaultMessage = addMissingOpenSSLInfo(`${import_chalk6.default.redBright(errorOutputAsJSON.message)}`);
        const { error_code: errorCode } = errorOutputAsJSON;
        return new GetDmmfError({
          _tag: "parsed",
          message: defaultMessage,
...
${e3.error?.stack}`;
    const error = new GetDmmfError({
      _tag: "unparsed",
      message,
      reason: `${import_chalk6.default.redBright.bold("JSON parsing")} - ${e3.reason}
`
    });
    return right2(error);
  }).with({ type: "retry" }, (e3) => {
  ...
  debug8(`Waiting "${retryTimeout}" seconds before retrying...`);
  await new Promise((resolve) => setTimeout(resolve, retryTimeout));
  debug8(retryReason);
  return getDmmfBinary({ ...options2, retry: (options2.retry ?? 0) - 1 });
}
...
`
    )}${import_chalk6.default.green.bold("apt-get -qy update && apt-get -qy install openssl")}`;
  }
  return message;
}
__name(addMissingOpenSSLInfo, "addMissingOpenSSLInfo");
function warnOnDeprecatedFeatureFlag(previewFeatures) {
  const getMessage = /* @__PURE__ */ __name((flag) => `${import_chalk6.default.blueBright(
    "info"
...
P.cubeRoot = P.cbrt = function() {
  var e3, m2, n3, r3, rep, s, sd, t4, t32, t3plusx, x = this, Ctor = x.constructor;
  ...
  for (; ; ) {
    t4 = r3;
    t32 = t4.times(t4).times(t4);
    t3plusx = t32.plus(x);
    r3 = divide(t3plusx.plus(x).times(t4), t3plusx.plus(t32), sd + 2, 1);
    if (digitsToString(t4.d).slice(0, sd) === (n3 = digitsToString(r3.d)).slice(0, sd)) {
      n3 = n3.slice(sd - 3, sd + 1);
      if (n3 == "9999" || !rep && n3 == "4999") {
        if (!rep) {
          finalise(t4, e3 + 1, 0);
          if (t4.times(t4).times(t4).eq(x)) {
            r3 = t4;
            break;
          }
        }
  ...
  external = true;
  return finalise(r3, e3, Ctor.rounding, m2);
};
...
P.inverseTangent = P.atan = function() {
  var i, j, k, n3, px, t4, r3, wpr, x2, x = this, Ctor = x.constructor, pr = Ctor.precision, rm = Ctor.rounding;
  if (!x.isFinite()) {
    if (!x.s)
      return new Ctor(NaN);
  ...
  for (; i !== -1; ) {
    px = px.times(x2);
    t4 = r3.minus(px.div(n3 += 2));
    px = px.times(x2);
    r3 = t4.plus(px.div(n3 += 2));
    if (r3.d[j] !== void 0)
      for (i = j; r3.d[i] === t4.d[i] && i--; )
        ;
  }
  if (k)
    r3 = r3.times(2 << k - 1);
...
P.squareRoot = P.sqrt = function() {
  var m2, n3, sd, r3, rep, t4, x = this, d3 = x.d, e3 = x.e, s = x.s, Ctor = x.constructor;
  if (s !== 1 || !d3 || !d3[0]) {
  ...
  for (; ; ) {
    t4 = r3;
    r3 = t4.plus(divide(x, t4, sd + 2, 1)).times(0.5);
    if (digitsToString(t4.d).slice(0, sd) === (n3 = digitsToString(r3.d)).slice(0, sd)) {
      n3 = n3.slice(sd - 3, sd + 1);
      if (n3 == "9999" || !rep && n3 == "4999") {
        if (!rep) {
...
P.times = P.mul = function(y2) {
  var carry, e3, i, k, r3, rL, t4, xdL, ydL, x = this, Ctor = x.constructor, xd = x.d, yd = (y2 = new Ctor(y2)).d;
  y2.s *= x.s;
  if (!xd || !xd[0] || !yd || !yd[0]) {
...
P.toPower = P.pow = function(y2) {
  var e3, k, pr, r3, rm, s, x = this, Ctor = x.constructor, yn = +(y2 = new Ctor(y2));
  ...
  if (e3 >= y2.d.length - 1 && (k = yn < 0 ? -yn : yn) <= MAX_SAFE_INTEGER) {
    ...
    return y2.s < 0 ? new Ctor(1).div(r3) : finalise(r3, pr, rm);
  }
  s = x.s;
  if (s < 0) {
    if (e3 < y2.d.length - 1)
  ...
  r3 = naturalExponential(y2.times(naturalLogarithm(x, pr + k)), pr);
  if (r3.d) {
    r3 = finalise(r3, pr + 5, 1);
    if (checkRoundingDigits(r3.d, pr, rm)) {
      e3 = pr + 10;
      r3 = finalise(naturalExponential(y2.times(naturalLogarithm(x, e3 + k)), e3), e3 + 5, 1);
...
var divide = function() {
  ...
  return function(x, y2, pr, rm, dp, base) {
    var cmp, e3, i, k, logBase, more, prod, prodL, q, qd, rem, remL, rem0, sd, t4, xi, xL, yd0, yL, yz, Ctor = x.constructor, sign2 = x.s == y2.s ? 1 : -1, xd = x.d, yd = y2.d;
    if (!xd || !xd[0] || !yd || !yd[0]) {
      return new Ctor(
...
function naturalExponential(x, sd) {
  var denominator, guard, j, pow2, sum2, t4, wpr, rep = 0, i = 0, k = 0, Ctor = x.constructor, rm = Ctor.rounding, pr = Ctor.precision;
  if (!x.d || !x.d[0] || x.e > 17) {
  ...
  for (; ; ) {
    ...
    t4 = sum2.plus(divide(pow2, denominator, wpr, 1));
    if (digitsToString(t4.d).slice(0, wpr) === digitsToString(sum2.d).slice(0, wpr)) {
      ...
      if (sd == null) {
        if (rep < 3 && checkRoundingDigits(sum2.d, wpr - guard, rm, rep)) {
          ...
          denominator = pow2 = t4 = new Ctor(1);
          i = 0;
          rep++;
        } else {
...
function naturalLogarithm(y2, sd) {
  var c, c0, denominator, e3, numerator, rep, sum2, t4, wpr, x1, x2, n3 = 1, guard = 10, x = y2, xd = x.d, Ctor = x.constructor, rm = Ctor.rounding, pr = Ctor.precision;
  ...
  if (Math.abs(e3 = x.e) < 15e14) {
    ...
    x = naturalLogarithm(new Ctor(c0 + "." + c.slice(1)), wpr - guard).plus(t4);
    Ctor.precision = pr;
  ...
  for (; ; ) {
    ...
    t4 = sum2.plus(divide(numerator, new Ctor(denominator), wpr, 1));
    if (digitsToString(t4.d).slice(0, wpr) === digitsToString(sum2.d).slice(0, wpr)) {
      sum2 = sum2.times(2);
      if (e3 !== 0)
      ...
      if (sd == null) {
        if (checkRoundingDigits(sum2.d, wpr - guard, rm, rep)) {
          Ctor.precision = wpr += guard;
          t4 = numerator = x = divide(x1.minus(1), x1.plus(1), wpr, 1);
          x2 = finalise(x.times(x), wpr, 1);
          denominator = rep = 1;
        } else {
          return finalise(sum2, Ctor.precision = pr, rm, external = true);
...
__name(sine, "sine");
function taylorSeries(Ctor, n3, x, y2, isHyperbolic) {
  var j, t4, u2, x2, i = 1, pr = Ctor.precision, k = Math.ceil(pr / LOG_BASE);
  external = false;
  x2 = x.times(x);
  u2 = new Ctor(y2);
  for (; ; ) {
    t4 = divide(u2.times(x2), new Ctor(n3++ * n3++), pr, 1);
    u2 = isHyperbolic ? y2.plus(t4) : y2.minus(t4);
    y2 = divide(t4.times(x2), new Ctor(n3++ * n3++), pr, 1);
    t4 = u2.plus(y2);
    if (t4.d[k] !== void 0) {
      for (j = k; t4.d[j] === u2.d[j] && j--; )
        ;
      if (j == -1)
        break;
    }
...
function toLessThanHalfPi(Ctor, x) {
  var t4, isNeg = x.s < 0, pi = getPi(Ctor, Ctor.precision, 1), halfPi = pi.times(0.5);
  x = x.abs();
  if (x.lte(halfPi)) {
    quadrant = isNeg ? 4 : 1;
    return x;
  ...
  if (t4.isZero()) {
    ...
    x = x.minus(t4.times(pi));
    if (x.lte(halfPi)) {
      quadrant = isOdd(t4) ? isNeg ? 2 : 3 : isNeg ? 4 : 1;
      return x;
    }
    quadrant = isOdd(t4) ? isNeg ? 1 : 4 : isNeg ? 3 : 2;
  }
  return x.minus(pi).abs();
}
__name(toLessThanHalfPi, "toLessThanHalfPi");
function toStringBinary(x, baseOut, sd, rm) {
  var base, e3, i, k, len, roundUp, str, xd, y2, Ctor = x.constructor, isExp = sd !== void 0;
  if (isExp) {
    checkInt32(sd, 1, MAX_DIGITS);
    if (rm === void 0)
      rm = Ctor.rounding;
...
function atan2(y2, x) {
  ...
  if (!y2.s || !x.s) {
    ...
    this.precision = wpr;
    this.rounding = 1;
    r3 = this.atan(divide(y2, x, wpr, 1));
    x = getPi(this, wpr, 1);
    this.precision = pr;
    this.rounding = rm;
    r3 = y2.s < 0 ? r3.minus(x) : r3.plus(x);
  } else {
    r3 = this.atan(divide(y2, x, wpr, 1));
  }
  return r3;
...
var import_copy = __toESM(require_copy3());
...
var DMMFSchemaHelper = class {
  ...
  getQueryType() {
    return this.schema.outputObjectTypes.prisma.find((t4) => t4.name === "Query");
  }
  getMutationType() {
    return this.schema.outputObjectTypes.prisma.find((t4) => t4.name === "Mutation");
  }
  getOutputTypes() {
    return {
...
function buildSingleFieldType(t4, noEnumerable = false, genericsInfo, source) {
  let type;
  if (typeof t4.type === "string") {
    if (t4.type === "Null") {
      return nullType;
    }
    const scalarType = GraphQLScalarToJSTypeTable[t4.type];
    ...
    type = namedInputType(scalarType ?? t4.type);
  } else {
    type = namedInputType(t4.type.name);
  }
  ifExtensions(() => {
  ...
  if (genericsInfo.needsGenericModelArg(t4)) {
    if (source) {
...
function buildAllFieldTypes(inputTypes, noEnumerable = false, genericsInfo, source) {
  ...
  const filteredInputTypes = inputTypes.filter((t4, i) => !singularPairIndexes.has(i));
  const inputObjectTypes = filteredInputTypes.filter((t4) => t4.location === "inputObjectTypes");
  const otherTypes = filteredInputTypes.filter((t4) => t4.location !== "inputObjectTypes");
...
${(0, import_indent_string9.default)(
          `objects: {
${(0, import_indent_string9.default)(
            model.fields.filter((f2) => f2.kind === "object").map((field) => new ModelOutputField(this.dmmf, field, false).toTS()).join("\n"),
            TAB_SIZE
          )}
}`,
          TAB_SIZE
...
${(0, import_indent_string9.default)(
            model.fields.filter((f2) => f2.kind === "scalar" || f2.kind === "enum").map((field) => new ModelOutputField(this.dmmf, field, !this.dmmf.typeMap[field.type]).toTS()).join("\n"),
            TAB_SIZE
          )}
...
${(0, import_indent_string9.default)(
      fields.filter((f2) => f2.outputType.location === "outputObjectTypes" && f2.name !== "_count").map((f2) => {
        ...
        return `
${f2.name}<T extends ${getFieldArgName(f2, name)}${ifExtensions(
          "<ExtArgs> = {}",
          "= {}"
        )}>(args?: Subset<T, ${getFieldArgName(f2, name)}${ifExtensions("<ExtArgs>", "")}>): ${getReturnType({
          name: fieldTypeName,
...
function interactiveTransactionDefinition() {
  ...
  const callbackType = functionType().addParameter(parameter("prisma", namedType("Prisma.TransactionClient"))).setReturnType(returnType);
...
`;
  ...
  toTS(edge = false) {
    ...
    const countTypes = this.dmmf.schema.outputObjectTypes.prisma.filter((t4) => t4.name.endsWith("CountOutputType")).map((t4) => new Count(t4, this.dmmf, this.genericsInfo, this.options.generator));
    const code = `
/**
 * Client
**/
...
${countTypes.map((t4) => t4.toTS()).join("\n")}
...
// src/generation/generator.ts
var debug9 = src_default("prisma:client:generator");
...
if (process.argv[1] === __filename) {
  generatorHandler({
    onManifest(config2) {
      ...
      debug9(`requiredEngine: ${requiredEngine}`);
      return {
